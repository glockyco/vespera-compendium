# Runtime evidence — build 24460838

Ran at: 2026-07-30T14:14:51.806Z

PASS 36 · FAIL 0 · SKIPPED 0 · UNRESOLVED 0
...
|---|---|---|---|---|
| parity | parity.probe | items | PASS | items: alias=I live=936 static=936 |
| parity | parity.probe | enemies | PASS | enemies: alias=t live=137 static=137 |
| parity | parity.probe | recipes | PASS | recipes: alias=R live=588 static=588 |
| parity | parity.probe | gatheringNodes | PASS | gatheringNodes: alias=G live=64 static=64 |
...
| parity | parity.probe | shopListings | PASS | shopListings: alias=T live=24 static=24 |
...
| records | gathering.runtime-extension | gatheringNodes | PASS | gatheringNodes: 10 deterministic samples matched |
| records | gathering.drop-normalization | gatheringNodes | PASS | gatheringNodes: 10 deterministic samples matched |
...
| records | shopListings.base-table | shopListings | PASS | shopListings: 8 deterministic samples matched |
